  ...
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert(
      ...
      [
        ...
        // PaymentType
        { Type: 'PaymentType', Code: 'CASH', CodeValueVI: 'Tiền mặt', ExtraValue: null, CodeID: 25 },
        ...
        { Type: 'ShippingStatus', Code: 'DELI', CodeValueVI: 'Đã giao hàng', ExtraValue: null, CodeID: 31 },
        ...
        // ShippingMethod
        { Type: 'ShippingMethod', Code: 'FAST', CodeValueVI: 'Giao hàng chuyển phát nhanh', ExtraValue: 30000.00, CodeID: 34 },
        { Type: 'ShippingMethod', Code: 'ECO', CodeValueVI: 'Giao hàng tiết kiệm', ExtraValue: 15000.00, CodeID: 35 },
        { Type: 'ShippingMethod', Code: 'EXPRESS', CodeValueVI: 'Giao hàng hỏa tốc', ExtraValue: 40000.00, CodeID: 36 },
        ...
        // AppointmentType
        { Type: 'AppointmentType', Code: 'FIRST', CodeValueVI: 'Lần đầu', ExtraValue: null, CodeID: 46 },
        { Type: 'AppointmentType', Code: 'FOLLOW_UP', CodeValueVI: 'Tái khám', ExtraValue: null, CodeID: 47 },

        // BannerStatus
        { Type: 'BannerStatus', Code: 'SHOW', CodeValueVI: 'Hiển thị', ExtraValue: null, CodeID: 48 },
        { Type: 'BannerStatus', Code: 'HIDE', CodeValueVI: 'Ẩn', ExtraValue: null, CodeID: 49 },

        // CancelReason
        { Type: 'CancelReason', Code: 'OTHER', CodeValueVI: 'Khác', ExtraValue: null, CodeID: 50 },
        { Type: 'CancelReason', Code: 'CHANGE_MIND', CodeValueVI: 'Đổi ý không muốn mua nữa', ExtraValue: null, CodeID: 51 },
        { Type: 'CancelReason', Code: 'BETTER_PRICE', CodeValueVI: 'Tìm thấy giá tốt hơn ở nơi khác', ExtraValue: null, CodeID: 52 },
        { Type: 'CancelReason', Code: 'NOT_NEEDED', CodeValueVI: 'Sản phẩm không còn cần thiết', ExtraValue: null, CodeID: 53 },
        { Type: 'CancelReason', Code: 'ORDER_ERROR', CodeValueVI: 'Lỗi trong quá trình đặt hàng', ExtraValue: null, CodeID: 54 },

        // ScheduleStatus
        { Type: 'ScheduleStatus', Code: 'AVAILABLE', CodeValueVI: 'Có sẵn', ExtraValue: null, CodeID: 55 },
        { Type: 'ScheduleStatus', Code: 'BOOKED', CodeValueVI: 'Đã đặt', ExtraValue: null, CodeID: 56 },
        { Type: 'ScheduleStatus', Code: 'UNAVAILABLE', CodeValueVI: 'Không có sẵn', ExtraValue: null, CodeID: 57 },
      ],
      {}
    );
  },
