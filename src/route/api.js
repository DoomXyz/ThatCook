...
let initAPIRoutes = (app) => {
  ...
  router.put(
    "/api/change-accountinfo",
    accountController.handleChangeAccountInfo
  );
  router.put("/api/change-password", accountController.handleChangePassword);

  router.get(
    "/api/get-sale-bannerinfo",
    bannerController.handleGetSaleBannerInfo
  );

  router.get(
    "/api/load-sale-productinfo",
    productController.handleLoadSaleProductInfo
  );
  router.get(
    "/api/get-sale-productinfo",
    productController.handleGetSaleProductInfo
  );
  router.get(
    "/api/get-productdetailinfo",
    productController.handleGetProductDetailInfo
  );
  ...
  router.get(
    "/api/get-account-invoiceinfo",
    invoiceController.handleGetAccountInvoiceInfo
  );
  router.get(
    "/api/get-invoicedetailinfo",
    invoiceController.handleGetInvoiceDetailInfo
  );
  router.put(
    "/api/change-invoicestatus",
    invoiceController.handleChangeInvoiceStatus
  );
  ...
  router.put(
    ...
    accountController.handleChangeAccountStatus
  );
  //owner
  ...
  router.put(
    "/api/change-productinfo",
    productController.handleChangeProductInfo
  );
  router.get(
    "/api/load-filtered-productinfo",
    productController.handleLoadFilteredProductInfo
  );
