          ...
          <form className="forgot-form-step" onSubmit={this.handleStep1Submit}>
            <div className="forgot-form-content">
              ...
              <div className="input-form">
                <input type="text" name="email" value={email} onChange={this.handleInputChange} placeholder="Email" required />
              </div>
            </div>
        ...
        return (
          <form className="forgot-form-step" onSubmit={this.handleStep2Submit}>
            <div className="forgot-form-content">
              <label>
                {' '}
                <b>Vui lòng nhập mã xác minh được gửi đến Email của bạn:</b>{' '}
              </label>
              <div className="input-form">
                <input type="text" name="verificationCode" value={verificationCode} onChange={this.handleInputChange} placeholder="Mã xác minh " required />
              </div>
            </div>
            <div className="button-submit">
              <button type="submit">Tiếp tục </button>
          ...
          <form className="forgot-form-step" onSubmit={this.handleStep3Submit}>
            <div className="forgot-form-content">
              <div className="input-form">
                ...
                <input type="text" name="newPassword" value={newPassword} onChange={this.handleInputChange} placeholder="Nhập lại mật khẩu " required />
              </div>
            </div>
            <div className="button-submit">
