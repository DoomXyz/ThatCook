...
class HomeAppointment extends Component {
  ...
  changeSlide = () => {
    this.setState((prevState) => ({
      currentIndex:
        (prevState.currentIndex + 1) % (this.state.bannerImages.length || 1),
    }));
  };
    ...
    this.setState((prevState) => ({
      currentIndex:
        prevState.currentIndex === 0
          ? (this.state.bannerImages.length || 1) - 1
      ...
      <div className="HomeAppointment-body">
        ...
        <HomeProductModal
          ...
          handleBuyNowFromModal={(masanpham, soluong, mactsp) =>
            console.log("Buy now:", masanpham, soluong, mactsp)
          }
          handleAddToCartFromModal={(masanpham, soluong, mactsp) =>
            console.log("Add to cart:", masanpham, soluong, mactsp)
          }
        />
        <Header
              ...
              <div
                ...
                style={{
                  transform: `translateX(calc(50% - 7rem - ${
                    doctorIndex * 14
                  }rem))`, // Center the active item
                }}
              >
                {doctors.map((doctor, index) => (
                  <div
                    className={`top-doctor-item ${
                      index === doctorIndex ? "active" : ""
                    }`}
                    key={index}
                  >
        ...
        <div className="bottom">
          <div className="f">
            <div className="bottom-left">
              ...
              <div className="stra"></div>
              <p>
                Website Thú Y Mincow luôn nỗ lực để đạt được sự hài lòng và tín
                nhiệm bằng chất lượng dịch vụ, trải nghiệm hoàn hảo với chi phí
                hợp lý. Đáp ứng kỳ vọng của khách hàng, đạt được sự tin tưởng
                gắn kết với sứ mệnh phát triển và nâng cao sức khoẻ cho thú cưng
                Việt Nam.
              </p>
              <div className="f">
                <img src={im1} />
