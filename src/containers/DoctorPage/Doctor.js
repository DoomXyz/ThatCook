...
class Doctor extends Component {
    ...
    renderForm() {
        ...
        const confirmedAppointments = appointments
            .filter((appointment) => appointment.status === 'Đã xác nhận')
                                            ...
                                            <div className="wait-appointment-button">
                                                {appointment.status === 'Chờ xác nhận' && (
                                                    <>
                                                        <button
                                                            type="button"
                                                            onClick={() => this.handleConfirm(appointment.id)}
                                                        ...
                                                        <button
                                                            type="button"
                                                            onClick={() => this.handleReject(appointment.id)}
                        ...
                        <div className="calendar-container">
                            ...
                            <div className="celendar-button">
                                <button
                                    ...
                                    className="celendar-button-left"
                                >
                                ...
                                <button
                                    ...
                                    className="celendar-button-right"
                                >
                                                ...
                                                {dayAppointments.map((appointment) => (
                                                    ...
                                                    >
                                                        <div className="description-appointment">
                                                            Thoi gian: {appointment.time.slice(11, 16)}
                                                        </div>
            ...
            <div className="doctor-page">
                ...
                <div className="doctor-container">
                    <div className="doctor-action-form">
                        <div
                            className={`doctor-action-info ${actionPage === 1 ? "active" : ""}`}
                            onClick={this.handleFormHoSoNguoiDung}
                        >
                            Hồ sơ bác sĩ
                        </div>
                        <div
                            className={`doctor-action-wait-appointment ${actionPage === 2 ? "active" : ""} || ${actionPage === 5 ? "active" : ""}`}
                            onClick={this.handleFormLichXacNhan}
                        >
                            Lịch cần xác nhận
                        </div>
                        <div
                            className={`doctor-action-celendar ${actionPage === 3 ? "active" : ""}`}
                            onClick={this.handleFormLichKham}
                        >
                            Lịch khám
                        </div>
                        <div
                            className={`doctor-action-history-appointment ${actionPage === 4 ? "active" : ""}`}
