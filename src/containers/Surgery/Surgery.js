      ...
      <div className="surgery-body">
        ...
        <div className="surgery-content f gen-container">
          ...
          <div className="surgery-content-right">
            ...
            <p>
              Dịch vụ phẫu thuật cơ bản cho thú cưng cung cấp các giải pháp y tế
              an toàn và hiệu quả, giúp cải thiện sức khỏe và chất lượng cuộc
              sống cho người bạn đồng hành của bạn. Với đội ngũ bác sĩ thú y
              giàu kinh nghiệm và cơ sở vật chất hiện đại, chúng tôi thực hiện
              các thủ thuật phổ biến như:
              <li>Triệt sản</li>
              <li>Cắt bỏ khối u hoặc u nang</li>
              <li>Xử lý vết thương</li>
              <li>Cắt cụt</li>
              <li>Phẫu thuật nha khoa</li>
              Mỗi ca phẫu thuật được tiến hành cẩn thận, từ kiểm tra sức khỏe
              trước phẫu thuật, gây mê an toàn đến chăm sóc hậu phẫu chu đáo,
              đảm bảo thú cưng hồi phục nhanh chóng. Dịch vụ được thiết kế phù
              hợp với mọi giống loài và tình trạng sức khỏe, mang lại sự an tâm
              tuyệt đối cho chủ nuôi, giúp thú cưng khỏe mạnh, vui vẻ và đồng
              hành lâu dài bên gia đình bạn.
            </p>
            <ul className="f">
              <li className="f">
                <img src={icon} />
